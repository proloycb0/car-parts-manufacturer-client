        ...
        <div className='lg:py-12 py-5'>
            <div className="hero lg:pt-20">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src="https://i.ibb.co/qkYw1Cj/a-1.webp" alt='' className="lg:max-w-lg rounded-lg shadow-2xl" />
            ...
            <div className="hero lg:py-16 py-5">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="https://i.ibb.co/Bj3KY4f/a-2.webp" alt='' className="lg:max-w-lg rounded-lg shadow-2xl" />
